$(document).ready(function() {
	...
	var option = {
		...
		series: [{
				name: '今日',
				type: 'bar',
				data: [2, 4, 7, 23, 25, 76, 135, 162, 70, 58, 70, 95, 52, 70, 175, 182, 48, 32, 20, 7, 23, 26, 6, 4],
				markPoint: {
					data: [{
							type: 'max',
							name: '最大值'
			...
			},
			{
				name: '昨日',
				type: 'bar',
				data: [2, 5, 4, 16, 18, 40, 105, 121, 48, 28, 135, 162, 70, 90, 135, 162, 70, 32, 12, 48, 18, 20, 6, 2],
				markPoint: {
					data: [{
							type: 'max',
							name: '最大值'
