	...
	$.extend(roleEdit.prototype, {
		...
		getDeviceInfoEvent: function() {
			...
			if(did) {
				...
				fnAjax.method_5(url_join1("Role/getInfo"), param, "get", function(msg) {
					if(msg.code == 0) {
						var data = msg.data;
						//设备ID输入框对象
						self.$roleName.val(data.name);
					} else {
		...
		formSubmitEvent: function() {
			...
			fnAjax.method_5(url_join1("Role/updateRole"), param, "post", function(msg) {
				if(msg.code == 0) {
					layer.alert("修改成功", {
						yes: function() {
